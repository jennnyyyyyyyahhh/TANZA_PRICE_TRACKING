...
function initializePage() {
    ...
    console.log('🌾 Rice & Grains page loaded successfully!');
}
...
const grainsPrices = {
    ...
    'jasmine-rice': {
        ...
        image: '../IMG/jasmine-rice.jpg',
        prices: {
            'public-market': { price: 75 },
            'puregold': { price: 85 },
            'sm-store': { price: 95 },
            'savemore': { price: 90 },
            'alfamart': { price: 88 }
...
function showPriceModal(productKey) {
    const product = grainsPrices[productKey];
    if (!product) return;
