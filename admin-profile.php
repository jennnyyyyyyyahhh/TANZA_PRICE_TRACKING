<?php
    ...
    // Determine which user to show: `user_id` param (admin view) or current session
    $userId = null;
    ...
    // Fetch user, profile and emergency contact info (fields requested)
    $stmt = $conn->prepare(
        "SELECT 
            u.id, u.first_name, u.last_name, u.user_code, u.email, u.password_hash, u.email_verified, u.verification_token, u.reset_token, u.reset_token_expiry, u.newsletter_subscribed, u.account_status, u.login_attempts, u.last_login_attempt, u.last_login, u.created_at, u.updated_at,
            p.id AS profile_id, p.user_id AS profile_user_id, p.phone_number, p.barangay, p.city, p.province, p.postal_code, p.profile_image_path, p.date_of_birth, p.gender, p.updated_at AS profile_updated_at,
            e.id AS emergency_id, e.user_id AS emergency_user_id,
            ...
            e.created_at AS emergency_created_at, e.updated_at AS emergency_updated_at
        FROM users u
                ...
                <div id="verificationBanner" class="verification-banner" style="display: none;">
                    ...
                    <div class="modal fade" id="editProfileModal" tabindex="-1" aria-labelledby="editProfileModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            ...
                            <form id="editProfileForm" method="POST" action="php/update_admin_profile.php" enctype="multipart/form-data">
